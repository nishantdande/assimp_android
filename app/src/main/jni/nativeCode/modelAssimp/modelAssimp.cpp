...
void ModelAssimp::PerformGLInits() {
    ...
    std::string objFilename, mtlFilename, texFilename, texFilename1;
//      bool isFilesPresent  =
...
//      bool isFilesPresent  =
//            gHelperObject->ExtractAssetReturnFilename("gltf/static/GE_Anim_Baked_gltf.gltf", objFilename) &&
//            gHelperObject->ExtractAssetReturnFilename("gltf/static/GE_Anim_Baked_gltf.bin", mtlFilename) &&
//            gHelperObject->ExtractAssetReturnFilename("gltf/static/GE_Machine_All_Texture.png", texFilename);


//        bool isFilesPresent  =
//            gHelperObject->ExtractAssetReturnFilename("gltf/sample/CesiumMan/CesiumMan.gltf", objFilename) &&
//            gHelperObject->ExtractAssetReturnFilename("gltf/sample/CesiumMan/CesiumMan0.bin", mtlFilename) &&
//            gHelperObject->ExtractAssetReturnFilename("gltf/sample/CesiumMan/CesiumMan.jpg", texFilename);


//      bool isFilesPresent  =
//            gHelperObject->ExtractAssetReturnFilename("gltf/sample/cube/Cube.gltf", objFilename) &&
